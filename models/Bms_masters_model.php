...
Class Bms_masters_model extends CI_Model {
    ...
    function auth_owner ($username,$pass) {
        $username = $this->db->escape_str($username);
        $pass = $this->db->escape_str($pass);
        $sql = "SELECT a.unit_id,unit_no,owner_name,a.property_id,a.email_addr,forgot_pass_key 
    ...
    function auth_resident ($username,$pass) {
        $username = $this->db->escape_str($username);
        $pass = $this->db->escape_str($pass);
        $sql = "SELECT a.unit_id,b.unit_no,a.tenant_name,b.property_id,a.email_addr,a.forgot_pass_key 
