...
Class Bms_unit_setup_model extends CI_Model {
    ...
    function get_unit_list ($offset = '0', $per_page = '25', $property_id ='', $search_txt ='') {
        ...
        $sql = "SELECT unit_id,a.property_id,a.block_id,block_name,unit_no,unit_status,floor_no,owner_name
    ...
    function get_unit_details ($unit_id) {
        ...
        $sql = "SELECT unit_id,a.property_id,block_id,unit_no,unit_status,floor_no,square_feet,share_unit,
                  ...
                  address_1,address_2,city,postcode,state,country,contact_1,contact_2,is_defaulter,status
                FROM  bms_property_units a               
    ...
    function get_owner_current ($unit_id) {
        $sql = "SELECT property_id,unit_no,owner_name,ic_passport_no,dob,race,religion,gender,nationality,email_addr,password,
