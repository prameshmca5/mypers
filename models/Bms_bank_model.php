...
Class Bms_bank_model extends CI_Model {
    function __construct () { parent::__construct(); }
    
    
     public function insertbdetail($data = array()){
     
        $insert = $this->db->insert('bms_bank_details',$data);
        if($insert){
    ...
    function auth ($username,$pass) {
     ...
     public function record_bank() {
        return $this->db->count_all("bms_bank_details");
    }
    ...
    public function fetch_bank($limit, $start) {
        $this->db->limit($limit, $start);
        $query = $this->db->get("bms_bank_details");
    ...
    public function bank()
  {
    $this->load->database();
    $this->db->select('*');
    $this->db->from('bms_bank_details');
   
    $query=$this->db->get();
    return $query->result();
  }	
 function getCommonDocss () {
     ...
     public function insertbankdetail($data = array()){
      	 ...
      	 function delete_ban($id)
  {
      ...
      $this->db->where('id', $id);
      $this->db->delete('bms_bank_details'); 
  }
  ...
  {
    $this->db->where('id',$id);
    $this->db->update('bms_bank_details',$data);
  }
	...
	// print_r($nam);exit;
	 ...
	 function getCommonDocs($search_txt) {
        ...
        $sql = "SELECT id,bank_name,ifc_code,branch_address,branch_number,city 
