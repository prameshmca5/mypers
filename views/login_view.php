...
<head>
  ...
  <title> <?php echo isset($browser_title) && $browser_title != '' ? $browser_title : 'Transpacc | BMS' ;?></title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="http://transpacc.com.my/index.html"><img src="<?php echo base_url();?>assets/images/logo2.png" alt="Transpacc | BMS" class="img-responsive center-block" /></a>
  </div>
  <!-- /.login-logo -->
