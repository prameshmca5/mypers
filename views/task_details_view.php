    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-xs-12 msg">
            <div class="col-xs-5">Task Status : </div>
            <div class="col-xs-6">
                <select class="form-control" id="task_update">
                	...
                	<option value="Waiting for resident reply">Waiting for resident reply</option>
                	<option value="Waiting for JMB/MC approval">Waiting for JMB/MC approval</option>
