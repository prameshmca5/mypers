...
<body onload="bodyOnLoad();">
		...
		<div class="col-md-12 col-xs-12 no-padding">
				...
				&nbsp;
		<form name="bms_frm" id="bms_frm" method="post" action="<?php echo base_url('index.php/receipt/addnew_bill');?>">
...
<?php if($unitno){ ?>
    ...
    <input type="hidden" name="loginname"  value="<?php echo isset($_SESSION['bms']['full_name']) ? $_SESSION['bms']['full_name'] : $_SESSION['bms']['first_name'];?>">
				...
				<div class="row">
                 <div class="col-md-1 col-xs-3">
                    ...
                    <?php   $querydp = $this->db->query("SELECT * FROM  bms_property_units where unit_no='$unitnos'");
  foreach ($querydp->result() as $rowpp)
  { $ownner = $rowpp->owner_name; }?>
					 ...
					 <div class="col-md-3 col-xs-5">
                        ...
                        <input type="text" value="<?php echo $ownner;?>" class="form-control">
                    </div>
  ...
  <input type="hidden" name="unit" id="dat" value="<?php echo $unitno ;?>" class="form-control">
 	...
 	<div class="row">
			 ...
			 <?php
			 $queryd = $this->db->query("SELECT * FROM  bms_property_credit where unit_no='$unitno' and status = '5'");
