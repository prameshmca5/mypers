                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 col-xs-6"> 
                        <select class="form-control" id="status_type" name="status_type">
                            ...
                            <option value="1" <?php echo !empty($_GET['status_type']) && $_GET['status_type'] == '1' ? 'selected="selected"' : '';?> >Done</option>
                            <option value="0" <?php echo isset($_GET['status_type']) && $_GET['status_type'] == '0' ? 'selected="selected"' : '';?>>Undone</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-3 col-xs-12">
                        <input class="btn btn-primary" onclick="window.location.href='<?php echo base_url('index.php/bms_notifications/add_todo');?>'" value="New To Do" type="button">
                    </div>
