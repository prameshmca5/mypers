   ...
   <h4 class="word_text text-primary text-center text-bold"><?php echo $pro_name; ?></h4>
    ...
    <div class="col-xs-12">
        <div class="table-responsive">
            ...
            <th class="text-right"><?php echo $poitem['subtotal'];?></th>
            </tr>
            <tr class="totals">
                <th colspan="8" class="text-right">Discount Amt</th>
                <th class="text-right"><?php echo $poitem['discounts'];?></th>
            </tr>
            <tr class="totals">
                <th colspan="8" class="text-right">Net Amount</th>
                <th class="text-right"><?php echo $poitem['nettotal'];?></th>
            </tr>
            <tr class="totals">
                <th colspan="8" class="text-right">Tax(<?php echo $poitem['tax_percent'];?> %)</th>
                <th class="text-right"><?php echo $poitem['tax_amt'];?></th>
            </tr>
            <tr class="primary">
            <!--<th class="word_text text-primary" colspan="2">
            Three hundred dollars </th>-->
