						...
						<div class="col-md-12 col-sm-12 col-xs-12 no-padding"
							...
							<div class="col-md-4">
								<div class="input-group date">
									...
									<input class="form-control pull-right datepicker"
										name="delivery_date" type="text" value="<?php echo !empty($poitem['delivery_date']) ? date('d-m-Y',strtotime($poitem['delivery_date'])) : ""; ?>"/>
								</div>
								<!-- /.input group -->
							</div>
									...
									<div class="col-md-2">
										<div class="form-group">
											<label>Unit Price</label> <input
												...
												id="unitprice_1" name="items[subunitprice][]" value="<?php echo $po_sub_items[0]['unit_price'];?>"  type="number" />
										</div>
									</div>
									...
									<div class="col-md-2">
										<div class="form-group">
											<label>Discount Amt</label> <input
												class="form-control amt_disct" value="<?php echo $po_sub_items[0]['discount_amt'];?>"  name="items[distamount][]"
				  ...
				  <div class="col-md-12 col-xs-12 no-padding">   
                        ...
                        if (! empty($poitem['po_no'])) { // SUB Routine Task
                            ...
                            if($total_count>1){
                                ...
                                ?>
                              	<div class="col-md-12 item_div_<?php echo ($dataid_incre); ?> sub_sop_<?php echo ($dataid_incre); ?>"
								style="background-color: #ECF0F5; margin: 10px 0 5px 0; padding: 10px 0 !important; border: 1px solid #999; border-radius: 5px;">
								<div class="col-md-12 no-padding">
									<div class="col-md-6">
										<div class="form-group">
												...
												<select
													...
													<option value="">Select</option>
														<?php
															$group_name = "";
															foreach ($expense_items as $key => $val) :
															$selected = isset( $valslice['cat_id']) && trim( $valslice['cat_id']) == $val['coa_id'] ? 'selected="selected" ' : '';
                                                                if ($val['coa_type_name'] != $group_name) {
																	if ($endLabel) {
																		echo '</optgroup>';
																	}
								...
								<div class="col-md-12 no-padding">
									...
									<div class="col-md-2">
										<div class="form-group">
											<label>Unit Price</label> <input
												...
												id="unitprice_<?php echo $dataid_incre;?>" name="items[subunitprice][]" value="<?php echo $valslice['unit_price'];?>"  type="number" />
										</div>
									</div>
									...
									<div class="col-md-2">
										<div class="form-group">
											<label>Discount Amt</label> <input
												class="form-control amt_disct" value="<?php echo $valslice['discount_amt'];?>"  name="items[distamount][]"
						...
						<div class="col-md-12 items_container col-xs-6" style="margin-top: 15px;">
						 <div class="col-md-12 no-padding style="padding-top: 5px !important;text-align: right;"">
                            ...
                            <div class="col-md-2 col-xs-12 ">
                              <input type="text" class="form-control resultsubtotal" name="rstsubtot" id="rstsubtot"  value="<?php echo (($poitem['subtotal']!='')?$poitem['subtotal']:0);?>" style="text-align: right;" readonly="true">
                            </div>   
                          </div>
                          ...
                          <div class="col-md-12 no-padding" style="padding-top: 5px !important;text-align: right;">
                            ...
                            <div class="col-md-2 col-xs-12 ">
                              <input type="text" class="form-control maindiscount" name="maindiscount" id="maindiscount" value="<?php echo (($poitem['discounts']!='')?$poitem['discounts']:0);?>"style="text-align: right;" >
                            </div>   
                          </div>
                          ...
                          <div class="col-md-12 no-padding" style="padding-top: 5px !important;text-align: right;">
                            ...
                            <div class="col-md-2 col-xs-12 ">
                              <input type="text" class="form-control mainntat" name="mainntat" id="mainntat"  value="<?php echo (($poitem['nettotal']!='')?$poitem['nettotal']:0);?>" style="text-align: right;" readonly="true">
                            </div>   
                          </div>
                          ...
                          <div class="col-md-12 no-padding" style="padding-top: 5px !important;text-align: right;">
                            ...
                            <div class="col-md-2 col-xs-12 ">
                              <input type="text" class="taxpers form-control" name="taxpers" value="<?php echo (($poitem['tax_percent']!='')?$poitem['tax_percent']:0);?>" style="text-align: right;" id="taxpers">
                            </div>   
                          </div>
                          ...
                          <div class="col-md-12 no-padding"style="padding-top: 5px !important;text-align: right;">
                            ...
                            <div class="col-md-2 col-xs-12 ">
                              <input type="text" class="taxamt form-control" name="taxamt" id="taxamt" value="<?php echo (($poitem['tax_amt']!='')?$poitem['tax_amt']:0);?>" style="text-align: right;" readonly="true">
                            </div>   
                          </div>
