                ...
                <form role="form" id="bms_frm" action="<?php echo base_url('index.php/bms_fin_payment/add_payment_order');?>" method="post" enctype="multipart/form-data">
                    <div class="row" style="padding-top: 15px;padding-bottom:15px;">
						...
						<div class="col-md-12 col-sm-12 col-xs-12 no-padding" style="padding-top: 15px !important;">
                            ...
                            <div class="col-md-4">
                                <span id="newprovide" <?php if($pv_item['pay_service_provider_name']!='') { ?> style="display: block;" <?php } else { ?>style="display: none;" <?php } ?>>
                                <input type="text" name="prov_inv_num" required="" value="<?php echo $pv_item['prov_inv_num'];?>" class="form-control">
                                </span>
                                <span id="newprovide">
                                <select class="form-control select2 show-tick selectpicker"  data-live-search="true"  id="po_number"
                                    name="pv_number[]" data-live-search="true" style="display: block;" multiple>
                                    <?php
