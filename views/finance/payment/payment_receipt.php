        ...
        <table width="100%">
            <tr>
                ...
                <td style="border: 0;  text-align: center" width="15%">
                    </br><img src='https://barcode.tec-it.com/barcode.ashx?data=<?php echo $pv_item['pay_no']; ?>&code=MobileQRCode&multiplebarcodes=false&translate-esc=false&unit=Fit&dpi=72&imagetype=Gif&rotation=0&color=%23000000&bgcolor=%23ffffff&qunit=Mm&quiet=0&modulewidth=50' alt='<?php echo $pv_item['pay_no']; ?>'/><br>
        ...
        <table id="meta">
            <tr>
                <td rowspan="5" style="border: 1px solid white; border-right: 1px solid black; text-align: left" width="62%">
                    ...
                    <table>
                        <b><?php echo ($provid_name!='')?$provid_name :$pv_item['pay_service_provider_name']; ?></b></br> 
        ...
        <table id="items">
           ...
           // }
            ...
            <tr>
                ...
                <td class="blank"> </td>
                <td align="right" class="total-value balance"><p style=""> <?php echo "Paid Amount";?></p></td>
