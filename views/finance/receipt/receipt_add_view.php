...
<h3 class="box-title">Quick Example</h3>
      ...
      <div class="box-body" style="padding-top: 15px;">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12" style="border: 1px solid #999;border-radius: 2px;">
          ...
          <form name="bms_frm" id="bms_frm" method="post" action="<?php echo base_url('index.php/bms_fin_receipt/add_receipt_submit'); ?>">
            <div class="row" style="padding-top: 15px;padding-bottom:15px;">
                ...
                <?php } ?>
                    ...
                    if(!empty($units)) {
                        foreach ($units as $key=>$val) {
                            $selected = isset($receipt['unit_id']) && $receipt['unit_id'] == $val['unit_id'] ?  'selected="selected" ' : '';
              ...
              <div class="col-md-12 col-sm-12 col-xs-12 no-padding" style="padding-top: 15px !important;">
                ...
                <div class="col-md-3 col-xs-5">                  
                  <input type="text" name="receipt[receipt_date]" value="<?php echo !empty($receipt['receipt_date']) ? date('d-m-Y',strtotime($receipt['receipt_date'])) : date("d-m-Y"); ?>" class="form-control datepicker" <?php echo $act_type == 'amend' ? 'readonly="true"': '';?> >
                </div>
              ...
              <div class="row pay_mode_details pay_mode_5" style="display: none;">
                  <div class="col-md-12" style="margin-top:15px;"> 
                    ...
                    <div class="col-md-2 col-xs-4">
                       <select name="receipt[previous_receipt]" class="form-control">
                            <option value="">Select</option>                            
                            <?php 
              ...
              <div class="row">
                  <div class="col-md-12">              
                    ...
                    <div class="col-md-7 col-xs-7">
                        <div class="col-md-6 col-xs-6 " style="margin-top:25px;">
                            ...
                            <div class="col-md-7 no-padding">
                                <input type="number" name="receipt[paid_amount]" id="paid_amount"  value="<?php echo !empty ($receipt['paid_amount']) ? $receipt['paid_amount'] : '';?>" class="form-control" style="text-align: right;" >
                            </div>
                        </div>
                    ...
                    <div class="col-md-2 col-xs-3 text-right" style="margin-top:25px;">
              ...
              <div class="row items_container" style="border: 1px solid #;background-color: #ECF0F5;border: 1px solid #999; border-radius: 5px;margin: 15px 5px; padding: 15px 0 20px 0 !important;" >
                ...
                ?>
                <div class="col-md-12 no-padding item_<?php echo ($Bkey+1);?>" style="padding-top: <?php echo ($Bkey+1) == 1 ? 0 : 10;?>px !important;" >
                    <div class="col-md-3 no-padding">
                        <div class="col-md-7">
...
function get_outstanding_bills (unit_id) {
    $.ajax({
        type:"post",
        async: true,
        url: '<?php echo base_url('index.php/bms_fin_receipt/getOutstandingBills/').($act_type == 'amend' ? count($receipt_items): '');?>',
        ...
        success: function(data) {
            ...
            if(data != '') {
                ...
                if(data_arr[0] == 'This Unit has Unapplied Amount!') {
                    alert('This Unit has Unapplied Amount!');
...
function load_sub_cat (cat_id,dd_id) {
    ...
    $.ajax({
        type:"post",
        async: true,
        url: '<?php echo base_url('index.php/bms_fin_receipt/getSubCategory');?>',
        data: {'cat_id':cat_id},
        datatype:"json", // others: xml, json; default is html
        beforeSend:function (){ $("#content_area").LoadingOverlay("show");  }, //
        success: function(data) {  
