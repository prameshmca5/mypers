        ...
        success: function(data) {  
            ...
            if(flag) {
                if (typeof (history.pushState) != "undefined") {
                    var update_url = '<?php echo base_url('index.php/bms_fin_bills/manual_bill_list');?>/'+offset+'/'+rows+'?property_id='+$('#property_id').val()+'&unit_id='+$("#unit_id").val()+'&from='+$("#from_date").val()+'&to='+$("#to_date").val();
