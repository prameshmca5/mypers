<head>
  ...
  <link rel="stylesheet" href="https://www.tpaccbms.com/bower_components/bootstrap/dist/css/bootstrap.min.css">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="https://www.tpaccbms.com/bower_components/font-awesome/css/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="https://www.tpaccbms.com/bower_components/Ionicons/css/ionicons.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="https://www.tpaccbms.com/dist/css/AdminLTE.min.css">

  <link rel="stylesheet" href="https://www.tpaccbms.com/dist/css/skins/skin-purple.min.css">
  <link rel="stylesheet" href="https://www.tpaccbms.com/assets/css/bms_media_query.css">
  <link rel="stylesheet" href="https://www.tpaccbms.com/assets/css/bms_custom_styles.css">
	<style type="text/css">
	@media print {
    .make-grid(sm);
            ...
            <tr>
                ...
                <td class="text-left"><?php
                    foreach ($expense_items as $expkey => $expval) {
                        if($expval['coa_id']==$subval['cat_id'])
                ...
                <?php $i++;
					...
					$discut = $subval['discounts'];
					$nttot = $subval['nettotal'];
					$txtper = $subval['tax_percent'];
					$txtamt = $subval['tax_amt'];
					$totat = $subval['total'];
					$editstat = "editrec";
				} ?>
            </tbody>
            <tfoot>
            <tr class="totals text-right">
            <th colspan="8" class="text-right">Sub Total</th>
            <th class="text-right"><?php echo (!empty($poitem['subtotal'])?$poitem['subtotal']:$subtot);?></th>
            </tr>
            <tr class="totals">
                <th colspan="8" class="text-right">Discount Amt</th>
                <th class="text-right"><?php echo (!empty($poitem['discounts'])?$poitem['discounts']:$discut);?></th>
            </tr>
            <tr class="totals">
                <th colspan="8" class="text-right">Net Amount</th>
                <th class="text-right"><?php echo (!empty($poitem['nettotal'])?$poitem['nettotal']:$nttot);?></th>
            </tr>
            <tr class="totals">
                <th colspan="8" class="text-right">Tax(<?php echo (!empty($poitem['tax_percent'])?$poitem['tax_percent']:$txtper);?> %)</th>
                <th class="text-right"><?php echo (!empty($poitem['tax_amt'])?$poitem['tax_amt']:$txtamt);?></th>
            </tr>
				
			 <tr class="primary">
				<th class="text-right text-primary" colspan="8">
					Grand Total (RM)
				</th>
