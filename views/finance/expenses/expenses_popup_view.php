...
<script type="text/javascript">
	document.getElementById("datavaladded").value=<?php echo $poitem['exp_inv_id'];?>;  
	$('.modeltitledisp').html('<i class="fa fa-file"></i> Expense Invoice Order Details (<?php echo $poitem['exp_doc_no'];?>)');
</script>