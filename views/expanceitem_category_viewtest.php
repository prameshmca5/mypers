...
.btn-primary2 {
 ...
 <a href="#" data-toggle="modal" data-target="#myModals" class="btn btn-primary" style="float:right;margin-right:5px;">Add Category</a>
  ...
  foreach ($cattv as $ttte)
  {
?>
                        <tr>
                            <td><?php echo $i; ?></td>
                            <td><?php   $ciphertext_base64 =  $ttte->datas; 
                        
 $key = $ttte->key_name;
     $key_size =   $ttte->keysize;
   $iv_size = $ttte->ivsize; 
    $iv = $ttte->iv; 
    $ciphertext_dec = base64_decode($ciphertext_base64);
  $iv_dec = substr($ciphertext_dec, 0, $iv_size);
    $ciphertext_dec = substr($ciphertext_dec, $iv_size);
  echo $plaintext_dec = mcrypt_decrypt(MCRYPT_RIJNDAEL_128, $key,$ciphertext_dec, MCRYPT_MODE_CBC, $iv_dec);
