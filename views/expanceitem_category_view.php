    ...
    <section class="content container-fluid cust-container-fluid">
      ...
      <!--------------------------
        ...
        <div style="clear: both;height: 0px;"></div>
              ...
              <h3 class="box-title" style="font-weight: bold;">Expenses Category</h3>
              
              <a href="<?php echo base_url();?>index.php/Expance_item_category/subcategory" class="btn btn-primary" style="float:right; ">Manage Subcategory</a>
   &nbsp;&nbsp;
 <a href="#" data-toggle="modal" data-target="#myModals" class="btn btn-primary" style="float:right;margin-right:5px;">Add Category</a>
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php 
                    ...
                    if(!empty($catt)) { $i = 1;
                       ...
                       <td> 
                       <a href="#" data-toggle="modal" data-target="#myModal<?php echo $val->excat_id;?>" title="Edit"><i class="fa fa-edit"></i></a>
                       
                           &nbsp;&nbsp;
 <a href="<?php echo base_url();?>index.php/Expance_item_category/delete/<?php echo $val->excat_id;?>" onclick="return confirm('Are you sure you want to delete this Category?');" title="delete"><i class="fa fa-trash"></i></a> 
    ...
    <div class="modal fade" id="myModal<?php echo $val->excat_id;?>">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form method="POST" action="<?php echo base_url();?>index.php/Expance_item_category/updatecat">
		  <div class="form-body">
            <div class="form-group">
              ...
              <div class="col-md-9" style="color:red;">
               <input type="text" name="name" class="form-control" value="<?php echo $val->excat_name; ?>">
                <input type="hidden" name="cat_id" class="form-control" value="<?php echo $val->excat_id; ?>">
              </div>
            </div>
		   </div>
		&nbsp;
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header" style="background-color: #337ab7;">
          <h4 class="modal-title" style="color: #fff;">Add Category</h4>
          <button type="button" style="color:#fff;margin-top: -23px;" class="close" data-dismiss="modal">&times;</button>
        </div>
        ...
        <div class="modal-body">
          ...
          <form method="POST" action="<?php echo base_url();?>index.php/Expance_item_category/add" class="form-horizontal">
		  <div class="form-body">
            <div class="form-group">
              <label class="control-label col-md-3" style="background-color: #ffffff;">Category Name</label>
              <div class="col-md-9" style="color:red;">
