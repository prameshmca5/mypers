...
<script>
    ...
    function take_snapshot() {
		...
		Webcam.snap( function(data_uri) {
            ...
            Webcam.upload( data_uri, '<?php echo base_url('index.php/bms_attendance/capture_save');?>?capture_for='+$('#capture_for').val()+'&remarks='+encodeURIComponent($('#remarks').val()), function(code, text) {
