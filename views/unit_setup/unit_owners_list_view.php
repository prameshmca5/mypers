...
<?php if(!empty($owner_info) && !empty($owner_info['owner_name'])) {  ?>
        <tr>
            ...
            <td class="text-center"><a href="javascript:;" class="add_owner_btn" data-value="curr_owner" data-unitId="<?php echo $unit_id;?>" data-toggle="modal" data-target="#myModal" title="Edit"><i class="fa fa-edit"></i></a></td>    
        </tr>
    <?php 
} else { ?>
...
<?php if(!empty($owner_hist)) {  
        ...
        <tr>
            ...
            <td class="text-center"><!--a href="javascript:;" title="View"><i class="fa fa-info-circle"></i></a> &ensp;-->
            <a href="javascript:;" class="add_owner_btn" data-value="<?php echo $val['unit_owner_id'];?>" data-unitId="<?php echo $unit_id;?>" data-toggle="modal" data-target="#myModal" title="Edit"><i class="fa fa-edit"></i></a></td>      
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body modal-body" style="margin-top: -15px;">
