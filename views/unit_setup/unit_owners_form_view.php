    ...
    <form role="form" id="bms_owner_frm" action="<?php echo base_url('index.php/bms_unit_setup/set_owners');?>" method="post" >
      <div class="col-md-12 col-xs-12" style="background-color: #ECF0F5;padding-top: 10px;">
                <div class="box box-info">
                    <div class="box-header with-border">
                      <h3 class="box-title"><b>Owner Details</b></h3>
                    </div>
                    <div class="box-body">
                            <?php if(!empty($unit_owner_id) && in_array ($unit_owner_id,array('curr_owner','new'))) { ?>
                                <div class="col-md-12 col-sm-12 col-xs-12 no-padding">
                                    <div class="form-group">
                                      <div class="checkbox">
                                        <label><input type="checkbox" name="owner[is_defaulter]" value="1" <?php echo isset($owner_hist_info['is_defaulter']) && $owner_hist_info['is_defaulter'] == '1' ? 'checked="checked"' : ''; ?> ><p class="text-danger">Defaulter Resident</p></label>
                                      </div>
                                    </div>
                                </div>
                               <?php } ?> 
                                <div class="col-md-12 col-sm-12 col-xs-12 no-padding">
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="owner[owner_name]" class="form-control" value="<?php echo isset($owner_hist_info['owner_name']) && $owner_hist_info['owner_name'] != '' ? $owner_hist_info['owner_name'] : '';?>" placeholder="Enter Owner Name" maxlength="100">
                                    </div>
                                    <input type="hidden" name="unit_owner_id" value="<?php echo $unit_owner_id;?>" />
  ...
  $(document).ready(function (){
    ...
    $( "#bms_owner_frm" ).validate({
		...
		messages: {			
            "owner[owner_name]": "Please enter Owner Name",
