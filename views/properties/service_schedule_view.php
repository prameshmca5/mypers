...
<?php
    ...
    $date_picker_end_date = !empty($service_provider['warranty_due']) ? "endDate: new Date('".$service_provider['warranty_due']."')," : "";
    ...
    $('.service_schedule_add_btn').click(function (){
        ...
        if($('#schedule_date').val() != '') {
            $.ajax({
                ...
                data: {'service_type':$('#service_type').val(),'schedule_date':$('#schedule_date').val(),'asset_id':$('#asset_id').val(),'warranty_status':$('#warranty_status').val()},
