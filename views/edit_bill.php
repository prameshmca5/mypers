...
<body onload="bodyOnLoad();">
			...
			<div class="row">
                    <div class="col-md-3 col-xs-6">
                        <td class="box-title"><b style="font-size: 159%;">Add Bill</b></td>
                       ...
                       <td><a role="button" class="btn btn-primary" href="<?php echo base_url('index.php/receipt/view_bill');?>">Back To List</a></td>
                    </div>
		...
		<div class="col-md-12 col-xs-12 no-padding">
				...
				&nbsp;
		<form name="bms_frm" id="bms_frm" method="post" action="<?php echo base_url('index.php/Receipt/updatebill');?>">
	...
	<div class="row">
                    ...
                    <div class="col-md-3 col-xs-5">
                            ...
                            <select class="form-control"  name="property" onChange="getblo(this.value);" readonly>
                        
                       <option value=""><?php echo $proidp ;?></option>
                    ...
                    <div class="col-md-3 col-xs-5">
                        ...
                        <div id="showblock"></div>
                          <div id="hideblock">
                            <select class="form-control" name="block_ido" readonly>
  ...
  { ?>
                    ...
                    <!--unit no section-->
					 ...
					 <div class="col-md-3 col-xs-5" style="">
					     ...
					     <div id="hidu">
<?php if($unitno){?>
  <select class="form-control" id="unit" name="unitd" readonly>
  ...
  <input type="hidden" name="unit" id="dat" value="<?php echo $unitno ;?>" class="form-control">
                        <input type="text" name="dat" id="dat" value="<?php echo $dates;?>" class="form-control datepicker" readonly>
                    </div>
               </div>	
 	...
 	<div class="row">
			 ...
			 <?php
			 $idd = $records[0]->id;
			  $receipt_no = $records[0]->receipt_no;
			 
			 
			 $queryd = $this->db->query("SELECT * FROM  bms_property_credit where receipt_no='$receipt_no' and external_bill_status = '1'");
  foreach ($queryd->result() as $rowp)
  {?>
    <form method="POST" action="<?php echo base_url();?>Receipt/updatebill">
      <div class="controler">
         <div class="col-md-12">
             <div class="row">
			  <table class="table table-bordered" style="width: 95%; margin-left: 10px; border: 2px solid #fff;"> 
                 <div class="col-md-3">
                    ...
                    <td style="width: 198px !important; border: 2px solid #fff;"> <select type="text" name="" class="form-control" readonly>
                 ...
                 <div class="col-md-2">
                     ...
                     <td style="width: 150px !important; border: 2px solid #fff;">  <select class="form-control"  style="width: 150px !important;" readonly>
                         <option value="<?php echo $rowp->subcategory;?>"><?php echo $rowp->subcategory;?></option>
                     </select></td>
                 </div>
                  <div class="col-md-3">
				
                    <td style="border: 2px solid #fff;"><input type="text" readonly  value="<?php echo $rowp->category_subcat;?>/<?php echo $rowp->subcategory;?>" class="form-control"></td>
                    
                 </div>

                 <div class="col-md-2">
				 <input type="hidden" name="mid"  value="<?php echo $rowp->id;?>">
                    <td><input type="text" name="amount"  class="form-control" value="<?php echo $rowp->amount;?>"></td>
                    
                 </div>

                 <div class="col-md-2">
				   <td>  
				       <button type="submit" class="btn btn-primary add-more" ><i class="glyphicon glyphicon-ok"></i></button>
				 <a href="<?php echo base_url();?>Receipt/deleteb/<?php echo  $rowp->id; ?>">
				    
			 <button type="button" class="btn btn-danger"  onclick="<?php echo base_url();?>Receipt/deleteb/<?php echo  $rowp->id; ?>'"><i class="glyphicon glyphicon-trash"></i></button>
			 </a>
				   </td>
                 </div>
				 </table>
...
<script>
    function refresh_div() {
        // var str = $("#units").val() ;
      	// alert("al");
        jQuery.ajax({
            url:"https://www.tpaccbms.com/index.php/Receipt/selcountedit/<?php echo $receipt_no; ?>",
            type:'POST',
    ...
    margin-left: -40px;   "></p>
				...
				&nbsp;
				 ...
				 <form method="POST" action="<?php echo base_url();?>Receipt/updatebilldetail">
				 <div class="row">
                    <div class="col-md-2 col-xs-6">
                       <h3><b>Notes</b></h3>
					  
                    </div>
					 <div class="col-md-10 col-xs-12" > <input type="hidden" name="mid"  value="<?php echo $records[0]->receipt_no; ?>">
                       <textarea rows="4" name="note" class="form-control" cols="50"><?php echo  $rowp->note; ?></textarea>
                    </div>
				...
				<div class="row">
                 <div class="col-md-2 col-xs-6"></div>
                    ...
                    <div class="col-md-6">
                        <input type="submit" name="submit" id="" value="Update"  class="btn btn-primary" style="float: right;">
...
function go(unit_id){
	...
	//alert(unit_id);
location='https://www.tpaccbms.com/index.php/Receipt/newone/'+unit_id;
