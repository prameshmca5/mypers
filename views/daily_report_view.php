                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group">
                            ...
                            <?php 
                                ...
                                foreach ($properties as $key=>$val) {
                                    $selected = '';
                                    if((isset($_GET['property_id']) && trim($_GET['property_id']) != '' && trim($_GET['property_id']) == $val['property_id']) || (isset($_SESSION['bms_default_property']) && $_SESSION['bms_default_property'] == $val['property_id'])){
