                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 no-padding">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                        <div class="form-group">
                                          ...
                                          <input type="text" name="staff[password]" class="form-control" value="<?php echo isset($staff_info['password']) && $staff_info['password'] != '' ? $staff_info['password'] : '';?>" placeholder="Password" maxlength="50">  
