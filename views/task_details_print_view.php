                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6 no-padding right-box1" style="border: 1px solid #999;border-radius: 5px;">
                                ...
                                <div class="col-md-12 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <?php echo isset($task_details->unit_status) ? $task_details->unit_status : ' - ';?>
                                    </div>
                                </div>
                                <div class="col-md-12 col-xs-12">
                                    <div class="form-group">
                                 ...
                                 <div class="col-md-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <span id="task_update_span">
                                          ...
                                          <?php echo isset($task_details->task_update) ? $task_details->task_update : ' - ';?>
                                        </span>
                                        <!-- /.input group -->
                                      </div>
                                </div>
                    ...
                    <label>Images :</label>
                        <div class="col-md-12" style="padding: 0 0 10px 0;min-height:150px;">                                        
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6" style="padding: 0;">                                               
                                    <img class="img-responsive center-block img_view img_view_<?php echo $task_id;?>"  style="max-height: 200px; max-width: 150px;cursor: pointer;" src="<?php echo ($_SERVER['SERVER_NAME'] == 'www.tpaccbms.com' ? 'https://www.tpaccbms.com/' : 'http://127.0.0.1/bms/v3/').'bms_uploads/task_uploads/'.$task_id.'/'.$task_images[$tkey]['img_name'];?>" />
                                </div>
                                <?php } ?>
                        </div>
