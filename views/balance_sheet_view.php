			...
			<div class="container-fluid">
				<form method="post">
					<div class="row formbdr-box">
						<div class="col-md-12">
							<div class="col-md-7">
								<h4 class="heding-txtsz">Balance Sheet</h4>
							</div>
							<div class="col-md-4"></div>
							<div class="col-md-5  tpbtnmgns">
								<button class="btn btn-primary" style="">R&P Statement</button>
								
								<button class="btn btn-primary">Trial Balance</button>
						...
						<div class="row sbrow">
							<div class="col-md-12 pdn-sbrws">
							  ...
							  <div class="row pddnrw">
									<div class="col-md-1 text-hdnwt">Monthly</div>
									...
									<div class="col-md-4 text-hdnwt">Financial Year</div>
									<div class="col-md-4">
									...
									<div class="col-md-4">
									   ...
									   <input type="submit" value="View Year" name="search1" class="btn btn-primary" >
							   ...
							   <div class="row pddnrw">
									<div class="col-md-1 text-hdnwt">Date</div>
									<div class="col-md-3">
										 <input type="text" name="reciptno" class="pdng-bdr-bx datepicker" id="">
									</div>
							    ...
							    <div class="row pddnrw">
									<div class="row">
									   ...
									   <a role="button" class="btn btn-primary " style="padding-left: 25px;padding-right: 25px;" onclick="printDiv('printableArea')" >Print</a>
										...
										<a role="button" class="btn btn-primary" href="<?php echo base_url('index.php/Receipt_report/balence_report/'.$man);?>">Download</a>
										...
										<div class="row" style="margin-top: 60px;">
											 ...
											 <h2 class="scn-2mg">Balance  Sheet</h2> 
										...
										<div class="col-md-8 col-sm-8 col-xs-8">
                                            <p></p><br>
											 ...
											 <div class="row">
												...
												<div class="col-md-4 col-sm-4 col-xs-4">
												      <p class="btm-tpbd"  ><span><b>0.00</b></span></p>
												</div>
									...
									<div class="row sbrow1">
										<div class="col-md-4 col-sm-4 col-xs-4">
										<p class="mnhdng-1"><b>Current Assets</b></p>
										<p><b>Bank</b></p>
										...
										<div class="col-md-8 col-sm-8 col-xs-8">
											...
											<div class="row">
											 ...
											 <div class="row">
												...
												<div class="col-md-4 col-sm-4 col-xs-4">
												      <p class="btm-tpbd"><span><b>00.0</b></span></p>
								    ...
								    <div class="row sbrow1">
										<div class="col-md-4 col-sm-4 col-xs-4">
										<p class="mnhdng-1"><b>TOTAL ASSETS</b></p>
									...
									<div class="row sbrow1">
										<div class="col-md-4 col-sm-4 col-xs-4">
										<p class="mnhdng-1"><b>Liabilities</b></p>
                                            ...
                                            <div class="row">
												...
												<div class="col-md-4 col-sm-4 col-xs-4">
												  <p></p><br>
												    <p></p><br>
											         ...
											         <?php
												     $qrmn = $this->db->query("SELECT amount FROM bms_property_credit where month='$man' and category_subcat ='Deposit'");
												    // $c = $qr->num_rows();
												 //echo $c ;exit;
											 ...
											 <div class="row">
												...
												<div class="col-md-4 col-sm-4 col-xs-4">
												      ...
												      <p class="btm-tpbd"><span>0.00</span></p>
												</div>
												<div class="col-md-4 col-sm-4 col-xs-4"></div>
											 </div>
										</div>
									...
									<div class="row sbrow1">
										<div class="col-md-4 col-sm-4 col-xs-4">
										<p class="mnhdng-1"><b>TOTAL LIABILITIES</b></p>
								   ...
								   <div class="row sbrow1">
									...
									<div class="row sbrow1">
										<div class="col-md-4 col-sm-4 col-xs-4">
										<p class="mnhdng-1"><b>Financed By</b></p>
										<p><b>  Accumulated Funds</b></p>
