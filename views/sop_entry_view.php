                                ...
                                ?>
                                  ...
                                  <div class="col-xs-9 col-sm-10">
                                    <div class="input-group">
                                        <input type="text" name="sop_reading" class="form-control inline sop_<?php echo $val['sop_id'];?>" placeholder="Enter Reading">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <?php } else { 
                                            ...
                                            ?>
                                              ...
                                              <div class="col-xs-9 col-sm-10">
                                                <div class="input-group">
                                                    <input type="text" name="sub_sop[<?php echo $key2;?>][reading]" class="form-control inline" placeholder="Enter Reading">
                                                    <!--span class="input-group-btn">
                                                        <button class="btn btn-primary" type="button"><i class="fa fa-camera"></i></button>
                                                    </span-->
                                                    <div class="input-group-btn">
