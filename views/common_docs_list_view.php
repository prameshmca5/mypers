      ...
      <!--------------------------
        ...
        <div class="row">
                    ...
                    <div class="col-md-3 col-xs-4">
                        <a role="button" class="btn btn-primary" href="<?php echo base_url('index.php/bms_document_center/add_doc');?>" >Add Document</a>
                    </div>
                    <?php } ?>                    
                ...
                <?php 
                    ...
                    if(!empty($common_docs)) {
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo base_url().'bms_uploads/document_center/'.$val['doc_file_name'];?>" target="_blank"><?php echo $val['doc_name'];?></a></td>
                            <td><?php echo $val['doc_description'] != '' ?  $val['doc_description'] : ' - ';?></td>
                            <td style="text-align: center;"><a href="<?php echo base_url().'bms_uploads/document_center/'.$val['doc_file_name'];?>" target="_blank" title="View / Download"><i class="fa fa-download"></i></a></td>
...
$(document).ready(function () {
    ...
    $('.list_filter').click(function () {
        ...
        window.location.href="<?php echo base_url('index.php/bms_document_center/common_docs_list');?>?search_txt="+search_txt;
        return false;        
    });
