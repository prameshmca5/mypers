...
class Bms_notifications extends CI_Controller {
    ...
    function to_do_list ($offset=0, $per_page = 25) {
        ...
        //$this->load->model('bms_masters_model');
        $data['browser_title'] = 'Property Butler | To Do List';
        $data['page_header'] = '<i class="fa fa-flag-o"></i> To Do List';
    ...
    function add_todo ($todo_id = '') {
        ...
        //$this->load->model('bms_masters_model');
        $data['browser_title'] = 'Property Butler | To Do';
        $data['page_header'] = '<i class="fa fa-flag-o"></i> To Do <i class="fa fa-angle-double-right"></i> New To Do';
    ...
    function add_todo_submit () {
        ...
        $_SESSION['flash_msg'] = 'To Do '. ($type == 'edit' ? 'Updated' : 'Added') .' successfully!';
        redirect('index.php/bms_notifications/to_do_list/0/25');
    }
