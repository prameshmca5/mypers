...
class Bms_index extends CI_Controller {	
    ...
    public function login() {
	   if(isset($_SESSION['bms']['is_logged_in']) && $_SESSION['bms']['is_logged_in'] == true) {
	       ...
	       $data['browser_title'] = 'Transpacc | BMS';
    ...
    function login_action ()	{ 
        $data['browser_title'] = 'Transpacc | BMS | Login Process';
    ...
    function change_password () {
        $data['browser_title'] = 'Transpacc | BMS | Change Password';
    ...
    public function logout() {
		$data['browser_title'] = 'Transpacc | BMS | Logout Process';
        $data['page_header'] = '<i class="fa fa-dashboard"></i> Dashboard';
        unset($_SESSION['bms']);
