...
//ob_start();
class Bms_task extends CI_Controller {
    ...
    public function task_list() {
		...
		$data['browser_title'] = 'Transpacc | BMS | Minor Task List';
        $data['page_header'] = '<i class="fa fa-info-circle"></i> Minor Task List';
        ...
        if($_SESSION['bms']['user_type'] == 'jmb') {
            ...
            $this->load->view('task_list_jmb_mc_view',$data);
        } else {
            ...
            $data['tasks'] = $this->bms_task_model->get_task ('own',$_SESSION['bms']['designation_id'],$_SESSION['bms']['staff_id'],'','',$data['property_id'],$task_status,$task_sear_id,$task_search_txt,$sort_by);
            //echo "<pre>";print_r($tasks);echo "</pre>";
            //$data['os_tasks'] = $this->bms_task_model->get_task ('oversee','0','10',$data['property_id'],$task_status);
            //echo "<pre>";print_r($os_tasks);echo "</pre>";
    ...
    public function new_task($type = '') {
		...
		$data['browser_title'] = 'Transpacc | BMS | Add Minor Task';
    ...
    function task_details ($task_id) {
        ...
        $data['browser_title'] = 'Transpacc | BMS | Minor Task Details';
    ...
    function email_test () {
        ...
        $result = $this->email
            ->from('admin@tpaccbms.com')
            ->reply_to('admin@tpaccbms.com')    // Optional, an account where a human being reads.
