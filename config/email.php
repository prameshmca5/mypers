...
$config['mailpath']         = '/usr/sbin/sendmail';// /usr/sbin/sendmail
$config['smtp_host']        = 'localhost';//pss20.win.hostgator.com
...
$config['smtp_user']        = '';
$config['smtp_pass']        = '';
/*$config['smtp_user']        = 'admin@tpaccbms.com';
$config['smtp_pass']        = 'ryOx4?67';*/
